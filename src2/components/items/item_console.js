    ...
    <>
      <div className="console">
        ...
        <div className="console-content">
          <button className='console-button cb-quote' disabled={item.control_disabled === true}>
        ...
        <div className="console-content">
          <div className="console-rating">
            <button className='console-button cb-left' disabled={item.control_disabled === true}>
              <div className="console-icon">
                <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className='console-button cb-right' disabled={item.control_disabled === true}>
              <div className="console-icon">
                <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="console-content">
          <button className='console-button cb-reply' disabled={item.control_disabled === true}>
            <div className="console-icon">
              <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <ToggleMenu 
        isOpen={isHeaderMenuOpen && !(item.control_disabled === true)} 
